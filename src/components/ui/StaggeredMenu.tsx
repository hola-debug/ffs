    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full  flex flex-col  overflow-y-auto z-10 backdrop-blur-[12px]"
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: white; backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 1em 1em 1em; overflow-y: auto; z-index: 10; }
