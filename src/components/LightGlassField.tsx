import { InputHTMLAttributes, ReactNode, SelectHTMLAttributes, forwardRef, memo } from 'react';
  ...
  ({ label, error, className = '', ...props }, ref) => {
    return (
      <div>
        ...
        <div className="rounded-xl border border-white/10 bg-neutral-950/60 transition-all focus-within:border-white/40 focus-within:ring-2 focus-within:ring-indigo-500/40">
          <input
            ref={ref}
